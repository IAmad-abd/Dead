                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        3939 absolute rejects wandering around #Solana
                                                        || Bringing in ever-evolving DeFi Utilities 🛠 Game
                                                        Theory
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (3663/3939)
                          </span>
                        </div>
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                                                                href="https://discord.com/channels/949681684188626944/949969009527361637"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                The Origins
                                                                The Dead Rejects wander in the afterverse,
                                                                having been neglected and rejected in society.
                                                                They go through the afterlife without any recognition
                                                                or acceptance for who they are. They are cursed to
                                                                wander the afterverse of Solana,
                                                                but their problems do not end there.

                                                                In general, being a Reject sucks. They don’t even
                                                                want to associate with their own kind — who would?
                                                                Instead, they shuffle along the afterverse,
                                                                sighing and bemoaning their existence. But not
                                                                everything sucks for the Rejects. There are some
                                                                things in the afterverse worth existing for.
                                                                DEDs is one of them. DEDs, now that’s good stuff,
                                                                if they could they would consume a fucking truckload of it.

                                                                The LifeBlood: $DED?

                                                                The Rejects are addicted to feeding on $DED,
                                                                they hunt for it in the afterverse. Without DEDs
                                                                rejects begin to fade away. Our token, $DED,
                                                                is the lifeblood of our ecosystem, we have a
                                                                bunch of planned inter-utilities that will be
                                                                exclusive to it. Additionally, $DED acts as a source
                                                                of passive income for all holders, therefore
                                                                attempting to maximize incentives to hold.
                                                                Each Genesis Reject can be minted for 1.75 SOL.
                                                                There will only ever be 3939 Dead Rejects.
                                                                All rejects survive and grow stronger by feeding on DEDs.
                                                                They wander in the Solana afterverse hunting for $DEDs,
                                                                without it, they begin to fade away.

                                                                Wait, there’s more of them?

                                                                The Undead’s

                                                                There is a catch. In the afterverse,
                                                                there are also the rarer higher order beings
                                                                known as the undead. They have managed to escape the rejection.
                                                                There will only ever be 3939 Dead Rejects. Each dead
                                                                reject can be staked to earn 7 $DED per day. However,
                                                                there will also be 3939 undead. To become undead,
                                                                a dead reject needs to spend 150 $DED. Undeads have a
                                                                higher claim to future mints in the dead rejects afterverse.
                                                                All undeads will always get preference over dead rejects.
                                                                So it is beneficial for dead rejects to upgrade
                                                                to undead status first. Undeads also acts as a
                                                                multiplier and receive higher staking rewards as
                                                                compared to dead rejects

                                                                Female Rejects

                                                                The dead rejects need to feel validated and so they
                                                                use their $DED to find female rejects with superior
                                                                powers in the Solana afterverse. Female rejects have
                                                                untamed powers that make them admired in the afterverse.
                                                                The rejects feel they have a shot at life if they can
                                                                mint a female reject. There are only 3939 female rejects.
                                                                Dead rejects must work hard and accumulate at least
                                                                250 $DED to mint a female reject.

                                                                However, if two dead rejects are combined, then only
                                                                125 $DED are needed to mint a female.
                                                                Female rejects on the other hand are not inclined
                                                                to partner up with dead rejects. They prefer
                                                                partnering with the undeads,
                                                                who are more advanced beings. As a result,
                                                                the dead rejects are in a constant pursuit to become
                                                                undead.

                                                                Once dead rejects become undead they can mint
                                                                females for 100 $DED. Minting a female reject
                                                                is the ultimate goal for both dead rejects and undeads.
                                                                It is a symbol of success. This success is rewarded
                                                                by the highest staking rewards. Female rejects
                                                                will receive the highest daily staking
                                                                rewards (the strongest multiplier). Risk:
                                                                Rejects are addicted to DEDs, they crave it.
                                                                Each month 15% of rejects that stop hunting for
                                                                $DED (de-stake) will lose 15% of their $DED and
                                                                it will be returned back into the afterverse for
                                                                other dead rejects to continue hunting (returned back to staking pool).
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                       - All Rejects enter the afterverse (private holder lounge)
                                                                        ...
                                                                        part of the DAO exclusive decision-making process to
                                                                        make sure holders have the ability to help facilitate and
                                                                        lead the project.
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        - $DED is launched and spread out across the afterverse.
                                                                          Rejects now have a chance at survival
                                                                        - Rejects can be staked to start accumulating $DED. Each
                                                                          rejects earns 7 $DED per day,
                                                                        - $90,000 USD (From Mint Revenue), Along with 90% of all
                                                                          Genesis Reject royalties (per month) will be put towards
                                                                          our Liquidity Pool to allow rejects to trade $DED easily on
                                                                          exchanges
                            </p>
                            <br />
                          </div>
                           <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Phase 4: The Lifeblood of the Afterverse; $DED
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        undeads. Undeads will act as a multiplier and offer
                                                                        higher staking rewards to holders in this phase.
                                                                        All unminted supply will be burnt.
                                                                        - Later In this phase, rejects come across female
                                                                        rejects and are enamored by their power and beauty.
                                                                        Female rejects can be minted by rejects using $DED
                                                                        or $SOL (With preference to reject holders).
                                                                        These female rejects are rare and with special abilities,
                                                                        so every reject wants to mint one.
                                                                        Female rejects give undeads preference.
                                                                        Holders with undeads will have priority in minting females.
                                                                        Females also act as multipliers and get even higher
                                                                        staking rewards compared to undeads.
                            </p>
                            <br />
                          </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Phase 5: The End…Of The Beginning
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        We plan to keep building out greater utilities
                                                                        for our ecosystem of holders. As our ecosystem
                                                                        expands we plan to add more benefits to users
                                                                        who hold all three, rejects, dead, undead ,
                                                                        and females. There will also be surprise
                                                                        elements to these mints. We will continue
                                                                        building until we break Solana.
                                                                    </p>
                                                                    <br />
                                                                </div>
